...
=========================
Backbone curves — absolute frequency (normalised).

Plots Ω / ω₀_base vs. peak transverse midpoint displacement for every arch
...
Output:  ../../results/backbone/backbone_absolute.png

Usage:
    python validation/plots/plot_backbone_absolute.py [--no-show]
"""
...
ax.set_title("Backbone curves — absolute frequency (normalised)")
ax.set_ylim(bottom=0)

fig.tight_layout()
out = OUT_DIR / "backbone_absolute.png"
