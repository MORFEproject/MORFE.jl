...
function read_mesh(mesh_file::String, Ω_list, materials_list, materials_dict,
    ...
    mesh.Γ = [Boundary() for i in 1:mesh.nΓ]
...
"""
function get_coor!(
        mesh::Grid, conn::SubArray{Int64, 1, Vector{Int64}, Tuple{UnitRange{Int64}}, true},
