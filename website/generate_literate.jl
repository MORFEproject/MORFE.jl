...
const EXAMPLES = [
	(id = "01_clamped_beam_ferrite", title = "Clamped-clamped beam — StructuralSVK",
		...
		gh = "$GH_FERRITE/tree/main/examples/01_clamped_beam_ferrite", custom = nothing),
	...
	(id = "03_arch_comsol_wedge", title = "COMSOL arch wedge — StructuralSVK",
		...
		gh = "$GH_FERRITE/tree/main/examples/03_arch_comsol_wedge", custom = nothing),
	(id = "04_parametric_clamped_beam", title = "Two-parameter beam — ParametricStructural",
		...
		gh = "$GH_FERRITE/tree/main/examples/04_parametric_clamped_beam", custom = nothing),
	...
	(id = "07_parametric_arch", title = "Parametric sinusoidal arch — ParametricStructural",
		...
		gh = "$GH_FERRITE/tree/main/examples/07_parametric_arch", custom = nothing),
