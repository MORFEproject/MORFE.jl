...
const OVERRIDES = Dict(
	"full_order_model.html" => Dict("multiindex" => "$(DOC_HREF)#MultilinearMaps-MultilinearMap"),
...
function main()
	...
	companion_symbols, companion_clashes =
		symbol_map(read(COMPANION_DOC_PAGE, String), COMPANION_DOC_HREF)
